    ...
    <main>
        <div class="boxwrapper">
            ...
            <section class="welcome box">
                ...
                <p class="cntr">
                    <a href="/projects/TooDooD/index.php" class="call-to-action">Visit project</a>
                </p>
            </section>
            <section class="welcome box">
                ...
                <p class="cntr">
                    <a href="/projects/php/page2.php" class="call-to-action">Visit project</a>
                </p>
            </section>
            <section class="welcome box">
                ...
                <p class="cntr">
                    <a href="/api-ajax-call-example/ajax.php" class="call-to-action">Visit project</a>
                </p>
            </section>
            <section class="welcome box">
                ...
                <p class="cntr">
                    <a href="/projects/php/page1.php" class="call-to-action">Visit project</a>
                </p>
            </section>
        </div>
    </main>
